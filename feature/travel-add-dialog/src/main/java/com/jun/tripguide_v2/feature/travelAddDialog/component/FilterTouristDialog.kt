package com.jun.tripguide_v2.feature.travelAddDialog.component
...
@Preview
@Composable
private fun FilterTouristDialogPreview() {
    MyTheme {
        FilterDialogContent(
            sortByList = Arrange.getValues(),
            typeByList = ContentType.getValues(),
            sortByItemClick = {},
            typeByItemClick = {},
            onBackClick = {}) {
